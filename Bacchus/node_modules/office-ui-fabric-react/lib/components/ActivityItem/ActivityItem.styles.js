...
exports.getStyles = Utilities_1.memoizeFunction(function (props, theme, customStyles) {
    if (theme === void 0) { theme = Styling_1.getTheme(); }
    var continuousPulse = Styling_1.PulsingBeaconAnimationStyles.continuousPulseAnimationSingle(props.beaconColorOne ? props.beaconColorOne : theme.palette.themePrimary, props.beaconColorTwo ? props.beaconColorTwo : theme.palette.themeTertiary, ANIMATION_INNER_DIMENSION, ANIMATION_OUTER_DIMENSION, ANIMATION_BORDER_WIDTH);
    var fadeIn = Styling_1.keyframes({
        from: { opacity: 0, },
        to: { opacity: 1, }
    });
    var slideIn = Styling_1.keyframes({
