...
var SuggestionsStore_1 = require("../../Suggestions/SuggestionsStore");
...
require("./FloatingPeoplePicker.Basic.Example.scss");
var FloatingPeoplePickerTypesExample = /** @class */ (function (_super) {
    ...
    function FloatingPeoplePickerTypesExample(props) {
        ...
        _this._onPickerChange = function (selectedSuggestion) {
            _this.setState({ searchValue: selectedSuggestion.primaryText ? selectedSuggestion.primaryText : '' });
    ...
    FloatingPeoplePickerTypesExample.prototype._renderFloatingPicker = function () {
        ...
        var suggestionProps = {
            footerItemsProps: [{
                    renderItem: function () { return (React.createElement("div", null,
                        "Showing ",
