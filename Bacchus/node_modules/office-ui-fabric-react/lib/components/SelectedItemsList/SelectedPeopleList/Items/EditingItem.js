...
var stylesImport = require("./EditingItem.scss");
...
var EditingItem = /** @class */ (function (_super) {
    ...
    function EditingItem(props) {
        ...
        _this._resolveInputRef = function (ref) {
            ...
            _this.forceUpdate(function () { _this._editingInput.focus(); });
        };
        ...
        _this._onInputBlur = function (ev) {
            if (_this._editingFloatingPicker.current &&
                (ev.relatedTarget === null || ev.relatedTarget.className.indexOf('ms-SearchMore-button') === -1)) {
