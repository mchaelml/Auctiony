define(["require", "exports", "tslib", "react", "../../Utilities", "../../Persona", "../../PersonaCoin", "./DocumentCard.scss"], function (require, exports, tslib_1, React, Utilities_1, Persona_1, PersonaCoin_1, stylesImport) {
    "use strict";
    ...
    var DocumentCardActivity = /** @class */ (function (_super) {
        ...
        DocumentCardActivity.prototype.render = function () {
            ...
            return (React.createElement("div", { className: Utilities_1.css('ms-DocumentCardActivity', styles.activity, (_b = {},
        ...
        DocumentCardActivity.prototype._renderAvatar = function (person) {
            return (React.createElement("div", { className: Utilities_1.css('ms-DocumentCardActivity-avatar', styles.avatar) },
                React.createElement(PersonaCoin_1.PersonaCoin, { imageInitials: person.initials, primaryText: person.name, imageUrl: person.profileImageSrc, initialsColor: person.initialsColor, allowPhoneInitials: person.allowPhoneInitials, role: 'persentation', size: Persona_1.PersonaSize.size32 })));
        };
