define(["require", "exports", "tslib", "react", "./KeytipLayer.styles", "../../Keytip", "../../Layer", "../../Utilities", "../../utilities/keytips/KeytipManager", "./KeytipTree", "../../utilities/keytips/KeytipUtils", "../../utilities/keytips/IKeytipTransitionKey", "../../utilities/keytips/KeytipConstants"], function (require, exports, tslib_1, React, KeytipLayer_styles_1, Keytip_1, Layer_1, Utilities_1, KeytipManager_1, KeytipTree_1, KeytipUtils_1, IKeytipTransitionKey_1, KeytipConstants_1) {
    ...
    var isMac = typeof navigator !== 'undefined' && navigator.userAgent.indexOf('Macintosh') >= 0;
    // Default sequence is Alt-Windows (Alt-Meta) in Windows, Option-Control (Alt-Control) in Mac
    var defaultStartSequence = {
        key: isMac ? 'Control' : 'Meta', modifierKeys: [IKeytipTransitionKey_1.KeytipTransitionModifier.alt]
    };
    ...
    var KeytipLayerBase = /** @class */ (function (_super) {
        ...
        function KeytipLayerBase(props, context) {
            ...
            _this._onKeyDown = function (ev) {
                ...
                switch (ev.which) {
                    ...
                    default:
                        ...
                        _this.processTransitionInput(transitionKey);
                        break;
                }
            };
            _this._onKeyPress = function (ev) {
                if (_this.state.inKeytipMode && !_this._keyHandled) {
                    // Call processInput
                    _this.processInput(ev.key.toLocaleLowerCase());
                    ev.preventDefault();
                    ev.stopPropagation();
                }
            };
            _this._onKeytipAdded = function (eventArgs) {
                ...
                _this.keytipTree.addNode(keytipProps, uniqueID);
                _this.setKeytips();
                // Add the keytip to the queue to show later
                if (_this.keytipTree.isCurrentKeytipParent(keytipProps)) {
                ...
                if (_this._isCurrentKeytipAnAlias(keytipProps)) {
                    ...
                    _this.keytipTree.currentKeytip = _this.keytipTree.getNode(KeytipUtils_1.sequencesToID(keytipSequence));
                }
            };
            _this._onKeytipUpdated = function (eventArgs) {
                var keytipProps = eventArgs.keytip;
                var uniqueID = eventArgs.uniqueID;
                _this.keytipTree.updateNode(keytipProps, uniqueID);
                _this.setKeytips();
            };
            _this._onKeytipRemoved = function (eventArgs) {
                ...
                _this.keytipTree.removeNode(keytipProps, uniqueID);
                _this.setKeytips();
            };
            _this._onPersistedKeytipAdded = function (eventArgs) {
                var keytipProps = eventArgs.keytip;
                var uniqueID = eventArgs.uniqueID;
                _this.keytipTree.addNode(keytipProps, uniqueID, true);
            };
            ...
            _this.keytipTree = new KeytipTree_1.KeytipTree();
            // Add regular and persisted keytips to the tree
            for (var _i = 0, _a = _this._keytipManager.keytips; _i < _a.length; _i++) {
                var uniqueKeytip = _a[_i];
                _this.keytipTree.addNode(uniqueKeytip.keytip, uniqueKeytip.uniqueID);
            }
            for (var _b = 0, _c = _this._keytipManager.persistedKeytips; _b < _c.length; _b++) {
                var uniquePersistedKeytip = _c[_b];
                _this.keytipTree.addNode(uniquePersistedKeytip.keytip, uniquePersistedKeytip.uniqueID);
            }
         ...
         */
        KeytipLayerBase.prototype.setKeytips = function (keytipProps) {
        ...
        KeytipLayerBase.prototype.render = function () {
            var _this = this;
            var _a = this.props, content = _a.content, getStyles = _a.getStyles;
            var _b = this.state, keytips = _b.keytips, visibleKeytips = _b.visibleKeytips;
            this._classNames = getClassNames(getStyles);
            return (React.createElement(Layer_1.Layer, { getStyles: KeytipLayer_styles_1.getLayerStyles },
                React.createElement("span", { id: KeytipConstants_1.KTP_LAYER_ID, className: this._classNames.innerContent }, content),
                React.createElement("span", { id: KeytipConstants_1.KTP_ARIA_SEPARATOR_ID, className: this._classNames.innerContent }, KeytipConstants_1.KTP_ARIA_SEPARATOR),
                keytips && keytips.map(function (keytipProps, index) {
                    return (React.createElement("span", { key: index, id: KeytipUtils_1.sequencesToID(keytipProps.keySequences), className: _this._classNames.innerContent }, keytipProps.keySequences.join(', ')));
                }),
         ...
         */
        KeytipLayerBase.prototype.enterKeytipMode = function () {
         ...
         */
        KeytipLayerBase.prototype.exitKeytipMode = function () {
         ...
         */
        KeytipLayerBase.prototype.processTransitionInput = function (transitionKey) {
            var currKtp = this.keytipTree.currentKeytip;
         ...
         */
        KeytipLayerBase.prototype.processInput = function (key) {
            ...
            if (currKtp) {
                var node = this.keytipTree.getExactMatchedNode(currSequence, currKtp);
                if (node) {
                    this.keytipTree.currentKeytip = currKtp = node;
                    var currKtpChildren = this.keytipTree.getChildren();
                ...
                var partialNodes = this.keytipTree.getPartiallyMatchedNodes(currSequence, currKtp);
                if (partialNodes.length > 0) {
                    ...
                    }).map(function (partialNode) { return partialNode.id; });
        ...
        KeytipLayerBase.prototype._persistedKeytipExecute = function (overflowButtonSequences, keytipSequences) {
            ...
            var overflowKeytipNode = this.keytipTree.getNode(KeytipUtils_1.sequencesToID(overflowButtonSequences));
        ...
        KeytipLayerBase.prototype._triggerKeytipImmediately = function (keytipProps) {
            ...
            // Set currentKeytip
            this.keytipTree.currentKeytip = this.keytipTree.getNode(KeytipUtils_1.sequencesToID(keytipSequence));
            if (this.keytipTree.currentKeytip) {
                // Show all children keytips if any
                var children = this.keytipTree.getChildren();
                if (children.length) {
         ...
         */
        KeytipLayerBase.prototype._getKeytipDOMElement = function (keytipId) {
            var dataKtpExecuteTarget = KeytipUtils_1.ktpTargetFromId(keytipId);
            return Utilities_1.getDocument().querySelector(dataKtpExecuteTarget);
        };
        /**
