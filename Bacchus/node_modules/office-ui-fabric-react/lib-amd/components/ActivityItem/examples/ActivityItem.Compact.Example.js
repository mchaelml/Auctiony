define(["require", "exports", "tslib", "react", "../../../Utilities", "../ActivityItem", "./ActivityItem.Example.styles", "../../../common/TestImages", "../../../Icon"], function (require, exports, tslib_1, React, Utilities_1, ActivityItem_1, ActivityItem_Example_styles_1, TestImages_1, Icon_1) {
    "use strict";
            ...
            var activityItemExamples = [
                {
                    key: 1,
                    activityDescription: [
                        React.createElement("span", { key: 1, className: Utilities_1.css(classNames.nameText) }, "Tahlia\tWhittle"),
                ...
                },
                {
                    key: 2,
                    activityDescription: [
                        React.createElement("span", { key: 1, className: Utilities_1.css(classNames.nameText) }, "Patrick Loton"),
                        React.createElement("span", { key: 2 }, " and "),
                        React.createElement("span", { key: 3, className: Utilities_1.css(classNames.nameText) }, " 6 others")
                    ],
                    activityPersonas: [
                        {
                            imageInitials: 'PT',
                ...
                },
                {
                    key: 3,
                    activityDescription: [
                        React.createElement("span", { key: 1, className: Utilities_1.css(classNames.nameText) }, "Sabrina De Luca"),
                        React.createElement("span", { key: 2 }, " added this file")
                    ],
                    activityIcon: React.createElement(Icon_1.Icon, { iconName: 'Add' }),
                    isCompact: true
                },
                {
                    key: 4,
                    activityDescription: [
                        React.createElement("span", { key: 1, className: Utilities_1.css(classNames.nameText) }, "Chuan Rojumanong"),
                        React.createElement("span", { key: 2 }, " shared this file")
                    ],
                    activityIcon: React.createElement(Icon_1.Icon, { iconName: 'Share' }),
                    isCompact: true
                }
            ];
