define(["require", "exports", "tslib", "react", "../../Utilities", "../../FocusZone", "../../Link", "../../Icon", "../../Button", "../../Utilities", "../../ResizeGroup", "../../Tooltip"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Link_1, Icon_1, Button_1, Utilities_2, ResizeGroup_1, Tooltip_1) {
    "use strict";
    ...
    var BreadcrumbBase = /** @class */ (function (_super) {
        ...
        function BreadcrumbBase(props) {
            ...
            _this._onRenderBreadcrumb = function (data) {
                var _a = data.props, ariaLabel = _a.ariaLabel, _b = _a.dividerAs, Divider = _b === void 0 ? Icon_1.Icon : _b, _c = _a.onRenderItem, onRenderItem = _c === void 0 ? _this._onRenderItem : _c, overflowAriaLabel = _a.overflowAriaLabel, overflowIndex = _a.overflowIndex;
                ...
                var itemElements = renderedItems.map(function (item, index) { return (React.createElement("li", { className: _this._classNames.listItem, key: item.key || String(index) },
                    ...
                    index !== lastItemIndex && React.createElement(Divider, { className: _this._classNames.chevron, iconName: Utilities_1.getRTL() ? 'ChevronLeft' : 'ChevronRight', item: item }))); });
                if (renderedOverflowItems && renderedOverflowItems.length !== 0) {
                    itemElements.splice(overflowIndex, 0, (React.createElement("li", { className: _this._classNames.overflow, key: OVERFLOW_KEY },
                        ...
                        React.createElement(Divider, { className: _this._classNames.chevron, iconName: Utilities_1.getRTL() ? 'ChevronLeft' : 'ChevronRight', item: renderedOverflowItems[renderedOverflowItems.length - 1] }))));
                }
                return (React.createElement("div", { className: _this._classNames.root, role: 'navigation', "aria-label": ariaLabel },
                    React.createElement(FocusZone_1.FocusZone, { componentRef: _this._focusZone, direction: FocusZone_1.FocusZoneDirection.horizontal },
        ...
        BreadcrumbBase.prototype.render = function () {
            var _a = this.props, _b = _a.onReduceData, onReduceData = _b === void 0 ? this._onReduceData : _b, overflowIndex = _a.overflowIndex, maxDisplayedItems = _a.maxDisplayedItems, items = _a.items, className = _a.className, theme = _a.theme, getStyles = _a.getStyles;
        ...
        BreadcrumbBase = tslib_1.__decorate([
            Utilities_2.customizable('Breadcrumb', ['theme'])
        ], BreadcrumbBase);
