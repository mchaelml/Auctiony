    ...
    var SpinButtonBasicExample = /** @class */ (function (_super) {
        ...
        SpinButtonBasicExample.prototype.render = function () {
            return (React.createElement("div", { style: { width: '400px' } },
                React.createElement(SpinButton_1.SpinButton, { defaultValue: '0', label: 'Basic SpinButton:', min: 0, max: 100, step: 1, 
                    // tslint:disable:jsx-no-lambda
                    onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); } }),
                React.createElement(SpinButton_1.SpinButton, { defaultValue: '0', label: 'Decimal SpinButton:', min: 0, max: 10, step: 0.1, onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); } })));
        };
