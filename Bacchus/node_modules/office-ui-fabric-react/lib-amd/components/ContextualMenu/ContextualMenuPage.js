define(["require", "exports", "tslib", "react", "@uifabric/example-app-base", "./examples/ContextualMenu.Basic.Example", "./examples/ContextualMenu.Icon.Example", "./examples/ContextualMenu.Section.Example", "./examples/ContextualMenu.Submenu.Example", "./examples/ContextualMenu.CustomizationWithNoWrap.Example", "./examples/ContextualMenu.Checkmarks.Example", "./examples/ContextualMenu.Directional.Example", "./examples/ContextualMenu.Customization.Example", "./examples/ContextualMenu.ScrollBar.Example", "./examples/ContextualMenu.CustomMenuItem.Example", "../../demo/ComponentStatus/ComponentStatus", "./ContextualMenu.checklist"], function (require, exports, tslib_1, React, example_app_base_1, ContextualMenu_Basic_Example_1, ContextualMenu_Icon_Example_1, ContextualMenu_Section_Example_1, ContextualMenu_Submenu_Example_1, ContextualMenu_CustomizationWithNoWrap_Example_1, ContextualMenu_Checkmarks_Example_1, ContextualMenu_Directional_Example_1, ContextualMenu_Customization_Example_1, ContextualMenu_ScrollBar_Example_1, ContextualMenu_CustomMenuItem_Example_1, ComponentStatus_1, ContextualMenu_checklist_1) {
    "use strict";
    ...
    var ContextualMenuPage = /** @class */ (function (_super) {
        ...
        ContextualMenuPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'ContextualMenu', componentName: 'ContextualMenuExample', componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/ContextualMenu', exampleCards: React.createElement("div", null,
                    ...
                    React.createElement(example_app_base_1.ExampleCard, { title: 'ContextualMenu with checkable menu items and toggable split button', code: ContextualMenuCheckmarksExampleCode },
