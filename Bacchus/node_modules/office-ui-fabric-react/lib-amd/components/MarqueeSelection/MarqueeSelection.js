define(["require", "exports", "tslib", "react", "./MarqueeSelection.scss", "../../Utilities"], function (require, exports, tslib_1, React, stylesImport, Utilities_1) {
    "use strict";
    ...
    var MarqueeSelection = /** @class */ (function (_super) {
        ...
        MarqueeSelection.prototype.render = function () {
            ...
            return (React.createElement("div", tslib_1.__assign({}, rootProps, { className: Utilities_1.css('ms-MarqueeSelection', styles.root, rootProps && rootProps.className), ref: this._root }),
                children,
