define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/SearchBox"], function (require, exports, tslib_1, React, SearchBox_1) {
    ...
    var SearchBoxFullSizeExample = /** @class */ (function (_super) {
        ...
        SearchBoxFullSizeExample.prototype.render = function () {
            return (React.createElement(SearchBox_1.SearchBox, { placeholder: 'Search', onFocus: function () { return console.log('onFocus called'); }, onBlur: function () { return console.log('onBlur called'); }, onChange: function () { return console.log('onChange called'); } }));
        };
