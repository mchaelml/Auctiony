define(["require", "exports", "tslib", "react", "../../Utilities", "../../Icon", "../../ContextualMenu", "./BaseButton.classNames", "./SplitButton/SplitButton.classNames", "../../KeytipData"], function (require, exports, tslib_1, React, Utilities_1, Icon_1, ContextualMenu_1, BaseButton_classNames_1, SplitButton_classNames_1, KeytipData_1) {
    "use strict";
    ...
    var BaseButton = /** @class */ (function (_super) {
        ...
        function BaseButton(props, rootClassName) {
            ...
            _this._onRenderMenu = function (menuProps) {
                ...
                return (React.createElement(ContextualMenu_1.ContextualMenu, tslib_1.__assign({ id: _this._labelId + '-menu', directionalHint: 4 /* bottomLeftEdge */ }, menuProps, { className: 'ms-BaseButton-menuhost ' + menuProps.className, target: _this._isSplitButton ? _this._splitButtonContainer.current : _this._buttonElement.current, labelElementId: _this._labelId, onDismiss: onDismiss })));
            };
