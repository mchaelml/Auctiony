define(["require", "exports", "tslib", "react", "../../Utilities", "../../utilities/dateValues/DateValues", "../../FocusZone", "../../Icon", "../../utilities/dateMath/DateMath", "./Calendar.scss"], function (require, exports, tslib_1, React, Utilities_1, DateValues_1, FocusZone_1, Icon_1, DateMath_1, stylesImport) {
    ...
    var CalendarDay = /** @class */ (function (_super) {
        ...
        function CalendarDay(props) {
            ...
            _this._onDayMouseDown = function (originalDate, weekIndex, dayIndex) {
                return function (ev) {
            ...
            _this._onDayMouseUp = function (originalDate, weekIndex, dayIndex) {
                return function (ev) {
            ...
            _this._onDayMouseOver = function (originalDate, weekIndex, dayIndex) {
                return function (ev) {
            ...
            _this._onDayMouseLeave = function (originalDate, weekIndex, dayIndex) {
                return function (ev) {
            ...
            _this._onTableMouseLeave = function (ev) {
                if (ev.target.contains && ev.target.contains(ev.relatedTarget)) {
                    return;
                }
                _this._applyFunctionToDayRefs(function (ref, day) {
                    if (ref) {
                    ...
                    React.createElement("table", { className: Utilities_1.css('ms-DatePicker-table', styles.table), "aria-readonly": 'true', "aria-multiselectable": 'false', "aria-labelledby": monthAndYearId, "aria-activedescendant": activeDescendantId },
                        React.createElement("thead", null,
                            React.createElement("tr", null,
                                showWeekNumbers && React.createElement("th", null),
                        ...
                        React.createElement("tbody", { onMouseLeave: dateRangeType === DateValues_1.DateRangeType.Month ? this._onTableMouseLeave : undefined, onMouseUp: dateRangeType === DateValues_1.DateRangeType.Month ? this._onTableMouseUp : undefined }, weeks.map(function (week, weekIndex) {
                            return React.createElement("tr", { key: weekNumbers ? weekNumbers[weekIndex] : weekIndex, role: 'row', className: (dateRangeType === DateValues_1.DateRangeType.Week || dateRangeType === DateValues_1.DateRangeType.WorkWeek) ? styles.weekHover : undefined },
                                showWeekNumbers && weekNumbers &&
                                    React.createElement("th", { className: Utilities_1.css('ms-DatePicker-weekNumbers', styles.weekNumbers), key: weekIndex, title: weekNumbers && strings.weekNumberFormatString && Utilities_1.format(strings.weekNumberFormatString, weekNumbers[weekIndex]), "aria-label": weekNumbers && strings.weekNumberFormatString && Utilities_1.format(strings.weekNumberFormatString, weekNumbers[weekIndex]), scope: 'row' },
                                ...
                                week.map(function (day, dayIndex) {
                                    ...
                                    return React.createElement("td", { key: day.key, className: Utilities_1.css((_a = {},
                                            ...
                                            _a)) },
                                        React.createElement("div", { key: day.key + 'div', className: Utilities_1.css('ms-DatePicker-day', styles.day, (_b = {},
                                                ...
                                                _b)), role: 'gridcell', onClick: day.isInBounds ? day.onSelected : undefined, onKeyDown: _this._onDayKeyDown(day.originalDate, weekIndex, dayIndex), "aria-label": dateTimeFormatter.formatMonthDayYear(day.originalDate, strings), id: isNavigatedDate ? activeDescendantId : undefined, "aria-selected": day.isInBounds ? day.isSelected : undefined, "data-is-focusable": day.isInBounds ? true : undefined, ref: function (element) { return _this._setDayRef(element, day, isNavigatedDate); }, onMouseOver: dateRangeType === DateValues_1.DateRangeType.Month ? _this._onDayMouseOver(day.originalDate, weekIndex, dayIndex) : undefined, onMouseLeave: dateRangeType === DateValues_1.DateRangeType.Month ? _this._onDayMouseLeave(day.originalDate, weekIndex, dayIndex) : undefined, onMouseDown: dateRangeType === DateValues_1.DateRangeType.Month ? _this._onDayMouseDown(day.originalDate, weekIndex, dayIndex) : undefined, onMouseUp: dateRangeType === DateValues_1.DateRangeType.Month ? _this._onDayMouseUp(day.originalDate, weekIndex, dayIndex) : undefined },
        ...
        CalendarDay.prototype._applyFunctionToDayRefs = function (func) {
            var _this = this;
            if (this.state.weeks && this.props.dateRangeType === DateValues_1.DateRangeType.Month) {
