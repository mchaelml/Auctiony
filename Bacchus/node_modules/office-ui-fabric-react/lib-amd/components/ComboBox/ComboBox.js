define(["require", "exports", "tslib", "react", "../../Button", "../../Callout", "../../Checkbox", "../../KeytipData", "../../Label", "../../Utilities", "../../utilities/selectableOption/SelectableOption.types", "../Autofill/index", "./ComboBox.classNames", "./ComboBox.styles"], function (require, exports, tslib_1, React, Button_1, Callout_1, Checkbox_1, KeytipData_1, Label_1, Utilities_1, SelectableOption_types_1, index_1, ComboBox_classNames_1, ComboBox_styles_1) {
    ...
    var ComboBoxOptionWrapper = /** @class */ (function (_super) {
        ...
        ComboBoxOptionWrapper.prototype.shouldComponentUpdate = function (newProps) {
            ...
            return !Utilities_1.shallowCompare(tslib_1.__assign({}, this.props, { children: undefined }), tslib_1.__assign({}, newProps, { children: undefined }));
        };
    ...
    var ComboBox = /** @class */ (function (_super) {
        ...
        function ComboBox(props) {
            ...
            _this._onUpdateValueInAutofillWillReceiveProps = function () {
                ...
                if (_this._currentVisibleValue && _this._currentVisibleValue !== '' && comboBox.value !== _this._currentVisibleValue) {
            ...
            _this._getVisibleValue = function () {
                var _a = _this.props, value = _a.value, allowFreeform = _a.allowFreeform, autoComplete = _a.autoComplete;
                ...
                if (_this.props.multiSelect) {
                    ...
                    if (focused) {
                        ...
                        displayValues.push(currentPendingValue !== '' ? currentPendingValue : (_this._indexWithinBounds(currentOptions, index) ? currentOptions[index].text : ''));
                    }
                    else {
                        for (var idx = 0; selectedIndices && (idx < selectedIndices.length); idx++) {
                            var index = selectedIndices[idx];
                            displayValues.push(_this._indexWithinBounds(currentOptions, index) ? currentOptions[index].text : suggestedDisplayValue);
                        }
                    }
                }
                else {
            ...
            _this._renderOption = function (item) {
                ...
                return (!_this.props.multiSelect ? (React.createElement(ComboBoxOptionWrapper, tslib_1.__assign({}, wrapperProps),
                    React.createElement(Button_1.CommandButton, { id: id + '-list' + item.index, key: item.key, "data-index": item.index, styles: optionStyles, checked: isSelected, className: 'ms-ComboBox-option', onClick: _this._onItemClick(item.index), onMouseEnter: _this._onOptionMouseEnter.bind(_this, item.index), onMouseMove: _this._onOptionMouseMove.bind(_this, item.index), onMouseLeave: _this._onOptionMouseLeave, role: 'option', "aria-selected": isSelected ? 'true' : 'false', ariaLabel: item.text, disabled: item.disabled },
                        " ",
                        React.createElement("span", { ref: isSelected ? _this._selectedElement : undefined }, onRenderOption(item, _this._onRenderOptionContent))))) : (React.createElement(ComboBoxOptionWrapper, tslib_1.__assign({}, wrapperProps),
                    React.createElement(Checkbox_1.Checkbox, { id: id + '-list' + item.index, ref: 'option' + item.index, ariaLabel: _this._getPreviewText(item), key: item.key, "data-index": item.index, styles: optionStyles, className: 'ms-ComboBox-option', "data-is-focusable": true, onChange: _this._onItemClick(item.index), label: item.text, role: 'option', "aria-selected": isSelected ? 'true' : 'false', checked: isSelected }, onRenderOption(item, _this._onRenderOptionContent)))));
            };
            /**
