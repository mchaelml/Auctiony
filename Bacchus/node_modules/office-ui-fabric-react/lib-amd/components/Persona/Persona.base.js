define(["require", "exports", "tslib", "react", "../../Utilities", "../../Tooltip", "./PersonaCoin/PersonaCoin", "./Persona.types"], function (require, exports, tslib_1, React, Utilities_1, Tooltip_1, PersonaCoin_1, Persona_types_1) {
    ...
    var PersonaBase = /** @class */ (function (_super) {
        ...
        PersonaBase.prototype.render = function () {
            ...
            var _b = this.props, allowPhoneInitials = _b.allowPhoneInitials, className = _b.className, coinProps = _b.coinProps, coinSize = _b.coinSize, getStyles = _b.getStyles, imageAlt = _b.imageAlt, imageInitials = _b.imageInitials, imageShouldFadeIn = _b.imageShouldFadeIn, imageShouldStartVisible = _b.imageShouldStartVisible, imageUrl = _b.imageUrl, initialsColor = _b.initialsColor, onPhotoLoadingStateChange = _b.onPhotoLoadingStateChange, onRenderCoin = _b.onRenderCoin, onRenderInitials = _b.onRenderInitials, presence = _b.presence, primaryText = _b.primaryText, showSecondaryText = _b.showSecondaryText, theme = _b.theme;
            ...
            var personaDetails = (React.createElement("div", { className: classNames.details },
                this._renderElement(this.props.primaryText, classNames.primaryText, onRenderPrimaryText),
