define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Panel"], function (require, exports, tslib_1, React, Button_1, Panel_1) {
    ...
    var PanelExtraLargeExample = /** @class */ (function (_super) {
        ...
        function PanelExtraLargeExample(props) {
        ...
        PanelExtraLargeExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Panel_1.Panel, { isOpen: this.state.showPanel, 
                    // tslint:disable-next-line:jsx-no-lambda
                    onDismiss: function () { return _this.setState({ showPanel: false }); }, type: Panel_1.PanelType.extraLarge, headerText: 'Extra Large Panel', closeButtonAriaLabel: 'Close' },
