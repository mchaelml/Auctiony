 ...
 * utilizes them.
 */
export var positioningFunctions;
...
})(positioningFunctions || (positioningFunctions = {}));
/**
 * @deprecated Do not use, this will be removed in 6.0.
 ...
 * @returns
 */
export function getRelativePositions(props, hostElement, calloutElement) {
 ...
 */
export function getMaxHeight(target, targetEdge, gapSpace, bounds) {
