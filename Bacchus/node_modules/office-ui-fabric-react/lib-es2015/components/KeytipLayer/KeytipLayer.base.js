...
import { ktpTargetFromId, sequencesToID, mergeOverflows } from '../../utilities/keytips/KeytipUtils';
import { transitionKeysContain, KeytipTransitionModifier } from '../../utilities/keytips/IKeytipTransitionKey';
import { KeytipEvents, KTP_LAYER_ID, KTP_ARIA_SEPARATOR_ID, KTP_ARIA_SEPARATOR } from '../../utilities/keytips/KeytipConstants';
...
var KeytipLayerBase = /** @class */ (function (_super) {
    ...
    function KeytipLayerBase(props, context) {
        ...
        _this._onKeytipAdded = function (eventArgs) {
            ...
            if (_this._isCurrentKeytipAnAlias(keytipProps)) {
                ...
                _this.keytipTree.currentKeytip = _this.keytipTree.getNode(sequencesToID(keytipSequence));
            }
        };
        ...
        _this.keytipTree = new KeytipTree();
    ...
    KeytipLayerBase.prototype.render = function () {
        ...
        return (React.createElement(Layer, { getStyles: getLayerStyles },
            React.createElement("span", { id: KTP_LAYER_ID, className: this._classNames.innerContent }, content),
            React.createElement("span", { id: KTP_ARIA_SEPARATOR_ID, className: this._classNames.innerContent }, KTP_ARIA_SEPARATOR),
            keytips && keytips.map(function (keytipProps, index) {
                return (React.createElement("span", { key: index, id: sequencesToID(keytipProps.keySequences), className: _this._classNames.innerContent }, keytipProps.keySequences.join(', ')));
            }),
            visibleKeytips && visibleKeytips.map(function (visibleKeytipProps) {
                return React.createElement(Keytip, tslib_1.__assign({ key: sequencesToID(visibleKeytipProps.keySequences) }, visibleKeytipProps));
            })));
    };
    ...
    KeytipLayerBase.prototype._persistedKeytipExecute = function (overflowButtonSequences, keytipSequences) {
        ...
        var overflowKeytipNode = this.keytipTree.getNode(sequencesToID(overflowButtonSequences));
    ...
    KeytipLayerBase.prototype._getKeytipDOMElement = function (keytipId) {
        var dataKtpExecuteTarget = ktpTargetFromId(keytipId);
