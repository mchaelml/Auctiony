...
var IconImageSheetExample = /** @class */ (function (_super) {
    ...
    IconImageSheetExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Icon, { iconName: 'None', iconType: IconType.image, className: 'ms-IconImageSheetExample-one', imageProps: {
                    src: TestImages.iconOne,
                    className: 'ms-IconImageSheetExample-one-image'
                } }),
            React.createElement(Icon, { iconName: 'None', iconType: IconType.image, className: 'ms-IconImageSheetExample-check', imageProps: {
                    src: TestImages.iconOne,
                    className: 'ms-IconImageSheetExample-check-image'
                } }),
            React.createElement(Icon, { iconName: 'None', iconType: IconType.image, className: 'ms-IconImageSheetExample-lock', imageProps: {
                    src: TestImages.iconOne,
