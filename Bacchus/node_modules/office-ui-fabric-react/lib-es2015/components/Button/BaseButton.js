...
import { BaseComponent, anchorProperties, assign, buttonProperties, getId, getNativeProps, createRef } from '../../Utilities';
...
var BaseButton = /** @class */ (function (_super) {
    ...
    function BaseButton(props, rootClassName) {
        ...
        _this._onRenderIcon = function (buttonProps, defaultRender) {
            ...
            if (iconProps) {
                return (React.createElement(Icon, tslib_1.__assign({}, iconProps, { className: _this._classNames.icon })));
            }
            return null;
        };
        ...
        _this._onRenderMenu = function (menuProps) {
            ...
            return (React.createElement(ContextualMenu, tslib_1.__assign({ id: _this._labelId + '-menu', directionalHint: 4 /* bottomLeftEdge */ }, menuProps, { className: 'ms-BaseButton-menuhost ' + menuProps.className, target: _this._isSplitButton ? _this._splitButtonContainer.current : _this._buttonElement.current, labelElementId: _this._labelId, onDismiss: onDismiss })));
        };
