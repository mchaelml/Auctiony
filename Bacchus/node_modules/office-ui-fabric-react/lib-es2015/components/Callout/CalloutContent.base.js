...
import { BaseComponent, assign, elementContains, focusFirstChild, getWindow, getDocument, customizable, css, createRef } from '../../Utilities';
...
var CalloutContentBase = /** @class */ (function (_super) {
    ...
    CalloutContentBase.prototype.render = function () {
        ...
        var content = (React.createElement("div", { ref: this._hostElement, className: this._classNames.container, style: visibilityStyle },
            React.createElement("div", { className: css(this._classNames.root, positions && positions.targetEdge && ANIMATIONS[positions.targetEdge]), style: positions ? positions.elementPosition : OFF_SCREEN_STYLE, tabIndex: -1, 
