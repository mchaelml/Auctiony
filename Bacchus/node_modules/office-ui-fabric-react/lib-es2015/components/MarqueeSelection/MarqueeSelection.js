...
import { AutoScroll, BaseComponent, css, findScrollableParent, getDistanceBetweenPoints, getRTL, createRef } from '../../Utilities';
...
var MarqueeSelection = /** @class */ (function (_super) {
    ...
    MarqueeSelection.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({}, rootProps, { className: css('ms-MarqueeSelection', styles.root, rootProps && rootProps.className), ref: this._root }),
            children,
            dragRect && (React.createElement("div", { className: css('ms-MarqueeSelection-dragMask', styles.dragMask) })),
            dragRect && (React.createElement("div", { className: css('ms-MarqueeSelection-box', styles.box), style: dragRect },
                React.createElement("div", { className: css('ms-MarqueeSelection-boxFill', styles.boxFill) })))));
    };
