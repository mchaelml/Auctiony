...
import { BaseComponent, classNamesFunction, customizable, divProperties, getNativeProps, createRef } from '../../Utilities';
...
var ScrollablePaneBase = /** @class */ (function (_super) {
    ...
    function ScrollablePaneBase(props) {
        ...
        _this._stickyAboveRef = createRef();
        _this._stickyBelowRef = createRef();
    ...
    ScrollablePaneBase.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({}, getNativeProps(this.props, divProperties), { ref: this._root, className: classNames.root, "data-is-scrollable": true }),
