...
export var SuggestedBigItem = function (documentProps, itemProps) {
    ...
    return (React.createElement(Persona, { imageUrl: documentPreviewProps && documentPreviewProps.previewImages[0].previewImageSrc, primaryText: documentTitleProps && documentTitleProps.title, size: PersonaSize.size40 }));
};
