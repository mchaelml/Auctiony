...
var PivotBase = /** @class */ (function (_super) {
    ...
    function PivotBase(props) {
        ...
        _this._renderPivotLink = function (link) {
            ...
            return (React.createElement(CommandButton, tslib_1.__assign({}, headerButtonProps, { id: tabId, key: itemKey, className: css('ms-Pivot-link', styles.link, (_a = {},
        ...
        _this._renderLinkContent = function (link) {
            ...
            return (React.createElement("span", { className: css('ms-Pivot-link-content') },
                itemIcon !== undefined && (React.createElement("span", { className: css('ms-Pivot-icon', styles.icon) },
                    React.createElement(Icon, { iconName: itemIcon }))),
                headerText !== undefined && React.createElement("span", { className: css('ms-Pivot-text', styles.text) },
                    " ",
                    link.headerText),
                itemCount !== undefined && React.createElement("span", { className: css('ms-Pivot-count', styles.count) },
                    " (",
                    itemCount,
                    ")")));
        };
    ...
    PivotBase.prototype._renderPivotLinks = function () {
        return (React.createElement(FocusZone, { componentRef: this.focusZone, direction: FocusZoneDirection.horizontal },
            React.createElement("ul", { className: css('ms-Pivot', styles.root, (_a = {}, _a['ms-Pivot--large ' + styles.rootIsLarge] = this.props.linkSize === PivotLinkSize.large, _a), (_b = {}, _b['ms-Pivot--tabs ' + styles.rootIsTabs] = this.props.linkFormat === PivotLinkFormat.tabs, _b)), role: 'tablist' }, this.state.links.map(this._renderPivotLink))));
        var _a, _b;
    };
    /**
