...
var ComboBoxOptionWrapper = /** @class */ (function (_super) {
    ...
    ComboBoxOptionWrapper.prototype.shouldComponentUpdate = function (newProps) {
        ...
        return !shallowCompare(tslib_1.__assign({}, this.props, { children: undefined }), tslib_1.__assign({}, newProps, { children: undefined }));
    };
    ...
    function ComboBox(props) {
        ...
        _this._renderOption = function (item) {
            ...
            return (!_this.props.multiSelect ? (React.createElement(ComboBoxOptionWrapper, tslib_1.__assign({}, wrapperProps),
                ...
                React.createElement(Checkbox, { id: id + '-list' + item.index, ref: 'option' + item.index, ariaLabel: _this._getPreviewText(item), key: item.key, "data-index": item.index, styles: optionStyles, className: 'ms-ComboBox-option', "data-is-focusable": true, onChange: _this._onItemClick(item.index), label: item.text, role: 'option', "aria-selected": isSelected ? 'true' : 'false', checked: isSelected }, onRenderOption(item, _this._onRenderOptionContent)))));
        };
        /**
