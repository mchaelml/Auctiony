...
var PersonaCustomCoinRenderExample = /** @class */ (function (_super) {
    ...
    PersonaCustomCoinRenderExample.prototype.render = function () {
        return (React.createElement("div", { className: 'ms-PersonaExample' },
            ...
            React.createElement(Persona, tslib_1.__assign({}, examplePersona, { size: PersonaSize.size72, presence: PersonaPresence.online, onRenderCoin: this._onRenderCoin, imageAlt: 'Custom Coin Image', coinSize: 72 }))));
    };
