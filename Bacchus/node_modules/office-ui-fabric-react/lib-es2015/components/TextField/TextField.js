...
var TextField = /** @class */ (function (_super) {
    ...
    function TextField(props) {
        ...
        _this._onRenderLabel = function (props) {
            if (props.label) {
                return (React.createElement(Label, { htmlFor: _this._id }, props.label));
            }
            return null;
        };
        _this._onRenderDescription = function (props) {
            if (props.description) {
                return (React.createElement("span", { className: css('ms-TextField-description', styles.description) }, props.description));
            }
            return null;
        };
    ...
    TextField.prototype.render = function () {
        ...
        var textFieldClassName = css('ms-TextField', styles.root, className, (_g = {},
