...
var BoxNoClickExample = /** @class */ (function (_super) {
    ...
    function BoxNoClickExample(props) {
        ...
        _this._onFocusTrapZoneToggleChanged = function (isToggled) {
            _this.setState({
                isToggled: isToggled
    ...
    BoxNoClickExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            (function () {
                if (isToggled) {
                    return (React.createElement(FocusTrapZone, { isClickableOutsideFocusTrap: true, forceFocusInsideTrap: false }, _this._internalContents()));
                }
                else {
    ...
    BoxNoClickExample.prototype._internalContents = function () {
        ...
        return (React.createElement("div", { className: 'ms-FocusTrapZoneBoxExample' },
            ...
            React.createElement("br", null),
            React.createElement(Toggle, { componentRef: this._setRef, checked: isToggled, onChanged: this._onFocusTrapZoneToggleChanged, label: 'Focus Trap Zone', onText: 'On', offText: 'Off' }),
            (function () {
                if (isToggled) {
...
export default BoxNoClickExample;
