...
var BreadcrumbBasicExample = /** @class */ (function (_super) {
    ...
    function BreadcrumbBasicExample(props) {
        ...
        _this._getCustomDivider = function (dividerProps) {
            ...
            return (React.createElement(TooltipHost, { content: "Show " + tooltipText + " contents", id: 'myID', calloutProps: { gapSpace: 0 } },
    ...
    BreadcrumbBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Label, { className: exampleStyles.exampleLabel, style: { marginTop: '24px' } }, "With Custom Divider Icon"),
            React.createElement(Breadcrumb, { items: [
                    { text: 'Files', 'key': 'Files', onClick: this._onBreadcrumbItemClicked },
                    { text: 'This is folder 1', 'key': 'f1', onClick: this._onBreadcrumbItemClicked },
                    { text: 'This is folder 2', 'key': 'f2', onClick: this._onBreadcrumbItemClicked },
            ...
            React.createElement(Label, { className: exampleStyles.exampleLabel, style: { marginTop: '24px' } }, "With maxDisplayedItems set to three and overflowIndex set to 1 (second element)"),
            React.createElement(Breadcrumb, { items: [
