...
var BreadcrumbBase = /** @class */ (function (_super) {
    ...
    function BreadcrumbBase(props) {
        ...
        _this._onRenderBreadcrumb = function (data) {
            var _a = data.props, ariaLabel = _a.ariaLabel, _b = _a.dividerAs, Divider = _b === void 0 ? Icon : _b, _c = _a.onRenderItem, onRenderItem = _c === void 0 ? _this._onRenderItem : _c, overflowAriaLabel = _a.overflowAriaLabel, overflowIndex = _a.overflowIndex;
            ...
            var itemElements = renderedItems.map(function (item, index) { return (React.createElement("li", { className: _this._classNames.listItem, key: item.key || String(index) },
                ...
                index !== lastItemIndex && React.createElement(Divider, { className: _this._classNames.chevron, iconName: getRTL() ? 'ChevronLeft' : 'ChevronRight', item: item }))); });
            if (renderedOverflowItems && renderedOverflowItems.length !== 0) {
                itemElements.splice(overflowIndex, 0, (React.createElement("li", { className: _this._classNames.overflow, key: OVERFLOW_KEY },
                    ...
                    React.createElement(Divider, { className: _this._classNames.chevron, iconName: getRTL() ? 'ChevronLeft' : 'ChevronRight', item: renderedOverflowItems[renderedOverflowItems.length - 1] }))));
            }
