...
var ModalBasicExample = /** @class */ (function (_super) {
    ...
    ModalBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(DefaultButton, { description: 'Opens the Sample Modal', onClick: this._showModal, text: 'Open Modal' }),
            React.createElement(Modal, { isOpen: this.state.showModal, onDismiss: this._closeModal, isBlocking: false, containerClassName: 'ms-modalExample-container' },
