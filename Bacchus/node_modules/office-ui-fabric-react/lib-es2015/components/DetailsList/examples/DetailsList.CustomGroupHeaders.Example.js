            ...
            React.createElement(DetailsList, { items: _items, groups: _groups, groupProps: {
                    onRenderHeader: function (props) { return (React.createElement("div", { className: 'DetailsListExample-customHeader' },
                        ...
                        React.createElement("div", { className: 'DetailsListExample-customHeaderLinkSet' },
                            React.createElement(Link, { className: 'DetailsListExample-customHeaderLink', onClick: _this._onClick(props) }, props.isSelected ? 'Remove selection' : 'Select group'),
                            React.createElement(Link, { className: 'DetailsListExample-customHeaderLink', onClick: _this._onClick(props) }, props.group.isCollapsed ? 'Expand group' : 'Collapse group')))); },
