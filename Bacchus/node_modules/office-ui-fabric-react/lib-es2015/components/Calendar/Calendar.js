...
import { css, BaseComponent, createRef } from '../../Utilities';
...
var Calendar = /** @class */ (function (_super) {
    ...
    function Calendar(props) {
        ...
        _this._navigateDay = function (date) {
            _this.setState({
                navigatedDate: date
            });
        };
        _this._onNavigateDate = function (date, focusOnNavigatedDay) {
            if (_this.props.isDayPickerVisible || (!_this.props.isDayPickerVisible && !focusOnNavigatedDay)) {
                _this._navigateDay(date);
